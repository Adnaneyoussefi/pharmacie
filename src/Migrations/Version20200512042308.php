 ...
 */
final class Version20200512042308 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE produit CHANGE nom nom VARCHAR(255) NOT NULL, CHANGE description description LONGTEXT NOT NULL, CHANGE date_expiration date_expiration DATE NOT NULL, CHANGE prix_ht prix_ht DOUBLE PRECISION NOT NULL, CHANGE prix_tva prix_tva DOUBLE PRECISION NOT NULL, CHANGE image image VARCHAR(255) NOT NULL');
