 ...
 */
final class Version20200604142542 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE categorie DROP proprietaire_id, CHANGE nom nom VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE produit ADD proprietaire_id INT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_29A5EC2776C50E4A ON produit (proprietaire_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE categorie ADD proprietaire_id INT DEFAULT NULL, CHANGE nom nom VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('DROP INDEX IDX_29A5EC2776C50E4A ON produit');
        $this->addSql('ALTER TABLE produit DROP proprietaire_id');
